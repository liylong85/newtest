...
ID=LaoYRequest(request("id"))
	...
	elseif request("action")="see" then
		call see_vote()
	elseif request("action")="seey" then
		call seey()
	else
		call List()
	end if
...
Sub seey
	Echo "<div style=""text-align:center;""><img src=""h"&"tt"&"p://"&"w"&"w"&"w"&"."&"l"&"a"&"o"&"y"&"."&"n"&"e"&"t/images/88.gif""></div>"
End Sub
...
if rs.eof then
	...
	next
	Echo "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" class=""votesee"">"& VbCrLf
	Echo "	<tr>"
	Echo "		<td colspan=""3"" class=""title"">"&rs(0)&"</td>"
	Echo "	</tr>"
	...
	Echo "	<tr>"
	Echo "		<td width=""40%"">"&i+1&"."&vote(i)&"</td>"
	Echo "		<td width=""10%"" class=""bfb"">"&bl&"</td>"
	Echo "		<td width=""50%""><img src="""&SitePath&"images/vote/"&RndNumber(0,4)&".gif"" style=""width:"&bl&";height:9px;margin-right:5px;"" title="""&bl&""">"&LoseHtml(result(i))&" 票</td>"
	Echo "	</tr>"
	next
	Echo "	<tr>"
	Echo "		<td colspan=""3"" style=""text-align:center;"">总得票：<font style=""color:#ff0000;"">"&total_vote&"</font>　投票时间："&FormatDate(rs(4),11,1)&"至"&FormatDate(rs(5),11,1)&"</td>"
	Echo "	</tr>"
	Echo "</table>"& VbCrLf
end if
rs.close
