...
K.options = {
	...
	items : [
		...
		'flash', 'media',  'table', 'hr', 'emoticons', 'baidumap', 
		'link', 'unlink', '|', 'pagebreak','about','fullscreen'
	],
	noDisableItems : ['source', 'fullscreen'],
	colorTable : [
		['#FF0000', '#E56600', '#FF9900', '#64451D', '#DFC5A4', '#FFE500', '#642100', '#6C3365', '#003D79', '#3C3C3C', '#5B4B00', '#007500'],
		['#009900', '#006600', '#99BB00', '#B8D100', '#60D978', '#00D5FF', '#A23400', '#8F4586', '#005AB5', '#4F4F4F', '#AE8F00', '#00BB00'],
		['#000099', '#003399', '#4C33E5', '#9933E5', '#CC33E5', '#EE33EE', '#D94600', '#AE57A4', '#0080FF', '#6C6C6C', '#D9B300', '#00EC00'],
...
_plugin('core', function(K) {
	...
	self.clickToolbar('about', function() {
		var html = '<div style="margin:20px;">' +
			...
			'<div>老y文章管理系统 <a href="http://www.laoy.net/" target="_blank">www.laoy.net</a></div>' +
			'</div>';
		self.createDialog({
			name : 'about',
			width : 350,
