function CheckName() {
	...
	else if(document.UserReg.UserName.value.length>12)
	{
		enter_name.innerHTML = "<img src='../images/check_err.gif' height='13' width='13'>&nbsp;<font color='#FF0000'>用户名不得多于12个字符</font>";
	return false;
	}
