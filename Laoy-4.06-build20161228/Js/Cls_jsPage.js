...
Cls_jsPage.prototype.Write=function(){
	...
	var FU,PU,NU,LU;
	var s1="<li> <a href=\"",s2="\">",s3="</a> </li>";
	var s4="<li> <span>",s5="</span> </li>";
	if (iPI<=1&&iPC<=1) {
		FU=s4+PF_D+s5;
		PU=s4+PP_D+s5;
		NU=s4+PN_D+s5;
	...
	if (iPC>=1) {
		...
		PInput="<li> <span><Input class=\""+CPI+"\" type=\"text\" name=\""+sPI+"\" size=\"5\" maxlength=\"10\" onkeydown=\"if (event.keyCode==32) "+sN+".PageJump()\"></span> </li>";
