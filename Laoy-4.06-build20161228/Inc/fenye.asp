...
Function ManualPagination1(str1,str2)
	...
	if Instr(strContent,"[yao_page]")<=0 then
		...
		if CurrentPage>1 then
			ManualPagination_Tmp = ManualPagination_Tmp & "<li><a href='"&apath(ArticleId,CurrentPage-1)&""
		...
		for i=1 to pages
			if i=CurrentPage then
				...
				ManualPagination_Tmp = ManualPagination_Tmp & "<li><a href='"&apath(ArticleId,i)&""
...
Function AutoPagination1(str1,str2,str3)
	...
	if ContentLen<=MaxPerPage then
		...
		if CurrentPage>1 then
			AutoPagination_Tmp = AutoPagination_Tmp & "<li><a href='"&apath(ArticleId,CurrentPage-1)&""
		...
		for i=1 to pages
			if i=CurrentPage then
				...
				AutoPagination_Tmp = AutoPagination_Tmp & "<li><a href='"&apath(ArticleId,i)&""
