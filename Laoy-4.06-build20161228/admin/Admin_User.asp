...
%>
    ...
    <td height="25" class="tdleft"><%if rs("QQOpenID")<>"" then Echo "<font color=red>【QQ登录】</font>" end if%><%=rs("UserName")%> (<font color=red> <%=mydb("Select Count([ID]) From ["&tbname&"_Article] Where UserID="&rs("ID")&"",1)(0)%> </font>)</td>
